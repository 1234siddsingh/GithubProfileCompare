  ...
  render() {
    return (
      <nav className="navbar navbar-dark bg-primary" >
        <span className="navbar-brand mb-0 h1">GithubCompare</span>
        <form className="form-inline" onSubmit={(e) => e.preventDefault()}>
          ...
          <button className="btn btn-light btn-outline-light my-2 my-sm-0" type="submit" onClick={this.handleSubmit}>Compare</button>
        </form>
      </nav>
    );
  }
